...
3. Sync Tokens into Jux: Sync your tokens into Jux’s token management system, allowing developers to access them via our [CLI](/developers/collaborate-with-designers).
...
3. Automatic Mapping: The plugin will automatically map your collections to token sets. In Jux, [token management](/designers/tokens) is organized into sets:
