...
We recommend starting by styling [elements](/editor/elements) according to your brand and product requirements. When you place  **an element on the canvas, it will automatically become a Local Component.**
