...
We recommend starting by styling [elements](/designers/elements) according to your brand and product requirements. When you place  **an element on the canvas, it will automatically become a Local Component.**
...
- Interactive states and editable properties appear in the [Dynamic Design Panel (DDP)](/designers/dynamic-design-panel)
- Design child elements within the [context of their parent](/designers/dynamic-design-panel/props-and-variants) component
