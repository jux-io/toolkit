...
<CaptionImage caption="Toggle Element">
...
- Style each part independently based on the checkbox's state and properties using the [parent context module](/designers/dynamic-design-panel/props-and-variants)
...
<CaptionImage caption="Toggle Anatomy">
...
<CaptionImage caption="Toggle Matrix">
