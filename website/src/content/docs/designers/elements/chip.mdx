...
You can influence the styling of the children of the chip in relation to the chip’s state and properties by selecting them in the parent [context module](/designers/dynamic-design-panel/props-and-variants).
